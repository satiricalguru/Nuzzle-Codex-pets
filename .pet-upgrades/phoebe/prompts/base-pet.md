Create one clean full-body reference sprite for Codex pet Phoebe.

Pet identity: Preserve the existing Phoebe identity, proportions, palette, markings, face, materials, props, and pixel-art/chibi style from the supplied 8x9 atlas. This is an upgrade: do not redesign the standard rows..
